...
export const loadGrammarConcepts = async () => {
  const [grammar1, grammar2, grammar3, grammar4, grammar5] = await Promise.all([
    ...
    import('@/lib/constants/grammar/grammar-5-classifiers').then(
      mod => mod.grammar5Classifiers
    )
  ])

  return [emptyConcept, grammar1, grammar2, grammar3, grammar4, grammar5]
}
